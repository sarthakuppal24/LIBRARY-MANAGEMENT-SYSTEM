...
class maincode:
     ...
     def cur(self):
             ...
             self.photo9=PhotoImage(file="D:\Desktop\PROJECT-SEM5\Library management System GUI\\bb.png")
             self.canvas8.create_image(0,0,image=self.photo9,anchor=NW)

             self.develop=Label(self.fm3,text='Developed By - Sumit and Sukant',bg='#fff',fg='blue',
    ...
    #-------------------------------------------SHOW BOOKS_------------------------------------------------
     ...
     def code(self):
         ...
         self.photo=PhotoImage(file="D:\Desktop\PROJECT-SEM5\Library management System GUI\images (17).png")
         ...
         self.photo1=PhotoImage(file="D:\Desktop\PROJECT-SEM5\Library management System GUI\dd.png")
